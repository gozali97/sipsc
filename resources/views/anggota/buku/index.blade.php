                                ...
                                <div class="modal fade bs-example-modal-lg" id="modalPinjam" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" id="modalPinjam{{ Auth::user()->id }}"
                                                action="{{ route('pinjam.store') }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="input-group custom">
                                                        <input type="text" name="nama"
                                                            value="{{ Auth::user()->nama }}"
                                                            class="form-control form-control-lg" placeholder="Nama Anggota"
                                                            readonly>
                                                    ...
                                                    <div class="input-group custom">
                                                        <select name="pustaka[]" class="custom-select2 form-control"
                                                            multiple="multiple" style="width: 100%;">
                                                            @foreach ($pustaka as $p)
                                                                <option value="{{ $p->id_pustaka }}">{{ $p->judul }} -
                                                                    {{ $p->tahun_terbit }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                        ...
                        @foreach ($pustaka as $p)
                            <li class="col-lg-4 col-md-6 col-sm-12">
                                <div class="product-box">
                                    <div class="producct-img"><img src="{{ url('/assets/img/' . $p->gambar) }}"
                                            alt=""></div>
                                    <div class="product-caption">
                                        ...
                                        <div class="modal fade bs-example-modal-lg"
                                            id="bd-example-modal-lg{{ $p->id_pustaka }}" tabindex="-1" role="dialog"
                                            aria-labelledby="myLargeModalLabel{{ $p->id_pustaka }}" aria-hidden="true"
                                            style="display: none;">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title"
                                                            id="bd-example-modal-lg{{ $p->id_pustaka }}">
                                                            Detail Pustaka</h4>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-hidden="true">×</button>
                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <img src="{{ url('/assets/img/' . $p->gambar) }}"
                                                                        style="width: 362px;height: 400px;"
                                                                        alt="">
                                                                </div>
                                                                <div class="col-md-6">
